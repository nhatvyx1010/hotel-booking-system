...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Thêm Thư Viện Ảnh</div>
        <div class="ps-3">
    ...
    <div class="col-lg-12">
        <div class="card">
                            ...
                            <form class="row g-3" action="{{ route('hotel.store.gallery') }}" method="post" enctype="multipart/form-data">
                            @csrf

									<div class="col-md-6">
										<label for="input1" class="form-label">Hình Ảnh Thư Viện</label>
