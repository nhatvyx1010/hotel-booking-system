        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Cập nhật cấu hình SMTP</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-sm-3">
                        <h6 class="mb-0">Mã hóa (Encryption)</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                ...
                <div class="row mb-3">
                    <div class="col-sm-3">
                        <h6 class="mb-0">Địa chỉ gửi (From Address)</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
